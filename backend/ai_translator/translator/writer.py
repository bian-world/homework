...
from reportlab.platypus import (
    SimpleDocTemplate, Paragraph, Table, TableStyle, PageBreak, Image
)

from backend.ai_translator import TEMP_DIR
from backend.ai_translator.book import Book, ContentType
            ...
            for content in page.contents:
                if content.status:
                    if content.content_type == ContentType.TEXT:
                        ...
                        content.original.save(temp_file)
                        img = Image(temp_file)
                        story.append(img)
